...
def doctorRegister(request):
    ...
    if(request.method=="POST"):
        ...
        if (Password==CPassword):
            ...
            Doctor=doctor(city=city,state=state,pincode=pincode,FName=FName,LName=LName,Password=Password,Email=Email,Address=Country,Profile=Profile,Username=Username)
            Doctor.save()
...
def PatientRegister(request):
     ...
     if(request.method=="POST"): 
            ...
            if (Password==CPassword):
                ...
                patient=Patient(pincode=pincode,city=city,state=state,FName=FName,LName=LName,Password=Password,Email=Email,Address=Country,Profile=Profile,Username=Username)
                patient.save()
